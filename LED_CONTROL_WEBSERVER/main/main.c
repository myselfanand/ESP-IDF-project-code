...
<body style=background-color:aqua><center>\
<h1 style=background-color:yellow;color:RED>WEB SERVER LED CONTROL</h1>\
<p style=font-size:200% >CONTROL LED BY BUTTON</p>\
<h2> LED STATE : OFF </h2>\
...
#define EXAMPLE_ESP_WIFI_SSID  "jcbro_labs"
#define EXAMPLE_ESP_WIFI_PASS   "JCBROLABS"
