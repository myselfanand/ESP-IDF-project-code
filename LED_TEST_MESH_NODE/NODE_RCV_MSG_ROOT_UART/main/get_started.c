...
///////////// GPIO BLINKING ////////////////
// static void _blink(uint8_t times) 
//     {
...
static void node_read_task(void *arg)
{
    ...
    for (;;) 
    {
        ...
        // else if(mwifi_is_connected())
        // {
        //  // printf("Inside else_if\n");
...
//         size = sprintf(data, "(%d) HELLO! ROOT HOW R U!", count++);
//         ret = mwifi_write(NULL, &data_type, data, size, true);
//         MDF_ERROR_CONTINUE(ret != MDF_OK, "mwifi_write, ret: %x", ret);
