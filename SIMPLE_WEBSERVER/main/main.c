...
static esp_err_t HelloWorld_handler(httpd_req_t *req)
{
    esp_err_t error;
    ESP_LOGI(TAG, "HELLO WORLD TEST ! ");
...
static const httpd_uri_t HelloWorld = {
    ...
    .user_ctx  = "WELCOME TO EMBEDDED GARAGE"
};
...
#define EXAMPLE_ESP_WIFI_SSID  "JCBRO"
#define EXAMPLE_ESP_WIFI_PASS   "JCBRO@321"
